...
if [ "$MODE" = "--nextjs" ]; then
  ...
  cp "$SRC/api/_lib.js" "$SRC/api/login.js" "$SRC/api/pages.js" "$SRC/api/upload.js" "$SRC/api/serve.js" "$SRC/api/content.js" "$SRC/api/social.js" "$SRC/api/health.js" "$DEST/api/"
